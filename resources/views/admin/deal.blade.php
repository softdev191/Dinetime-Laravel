...
<div class="container-fluid bg-010101">
	...
	<div class="row bg-title">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h4 class="page-title color-dce2ec"> Deal</h4>
		</div>
	</div>
	<!--/row -->
	<div class="row">
		<div class="col-md-12 col-lg-12 col-xs-12">
			<div class="white-box">
				<h3 class="box-title m-b-15 pull-left">All Deals</h3>
						...
						<tbody>
							...
							<tr>
								<td class="text-center">
									<a class="btn btn-danger btn-circle" onclick="return confirm(' Are you sure you want to delete this Deal?');" href="{{ route('removedeal',['deal_id' => $value->deal_id]) }}" data-toggle="tooltip" data-placement="top" title="Remove">
                                        <i class="ti-trash"></i>
									</a>
								</td>
								<td>
								...
								<td>--</td>
								@endif
								<td class="dealCreateDate" datetime="{{ $value->created_at }}">{{ date('m-d-Y',strtotime($value->created_at))}}</td>
							</tr>	
							@endforeach
						</tbody>
					</table>
...
<script type="text/javascript">
    $(document).ready(function() {
		...
		$('.dealCreateDate').each(function(i, e) {
