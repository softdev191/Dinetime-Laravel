	...
	<div class="row">
		<div class="col-md-12 col-lg-12 col-xs-12">
			<div class="white-box">
				...
				<a href="{{route('addvenue')}}" class="btn btn-info btn-rounded waves-effect waves-light pull-right m-b-15 m-r-15"><span>Add Venue</span> <i class="fa fa-plus m-l-5"></i></a>
						...
						@foreach($venueDetails as $value)
							<tr>
								<td class="text-center">
									...
									<a data-toggle="tooltip" data-placement="top" title="Edit Venue" class="btn btn-info btn-circle" href="{{ route('editvenue',['venue_id' => $value->venue_id]) }}">
